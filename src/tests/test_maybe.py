...
class TestMaybe(unittest.TestCase):
    ...
    def test_more_specific_type_is_allowed(self):
        ...
        def this_triggers_mypy_incompatible_return_value_when_types_not_covariant(
            value: int,
        ) -> Maybe[BaseClass]:
            subclassed_value = SubClass(value)

            none_or_subclassed_value: Maybe[SubClass] = Maybe.pure(subclassed_value)
        ...
        self.assertTrue(
            some_value == result,
            "Result should equal the generated value contained in the Maybe",
        )
